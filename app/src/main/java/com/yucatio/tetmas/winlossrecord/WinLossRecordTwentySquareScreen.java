...
public class WinLossRecordTwentySquareScreen extends Screen {
    private Context context;
    private WinLossRecordScreenManager manager;
    private WinLossRecordRenderer renderer;

    public WinLossRecordTwentySquareScreen(Game game, Context context) {
        super(game);
        this.context = context;

        manager = new WinLossRecordScreenManager(context, FieldSize.TWENTY_SQUARE, false, true);
