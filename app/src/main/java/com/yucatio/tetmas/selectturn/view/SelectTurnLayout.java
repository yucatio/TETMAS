...
public class SelectTurnLayout extends ScreenLayout {
    ...
    public static float[] firstMoverButton = new float[12];
    public static float[] secondMoverButton = new float[12];
    ...
    static {
        ...
        setVertexRect(firstMoverButton, x, y, width, height);
        y += yInterval;
        setVertexRect(secondMoverButton, x, y, width, height);
        y += yInterval;
        y += yGroupInterval;
