package com.yucatio.tetmas.selectturn.view;
...
import com.yucatio.tetmas.selectturn.SelectTurnScreenManager;
...
public class SelectTurnRenderer extends TetmasRenderer {
    ...
    public SelectTurnRenderer(SelectTurnScreenManager manager) {
    ...
    public void renderBackground() {
        ...
        vertexBuffer.put(SelectTurnLayout.background).position(0);
        ...
        vertexBuffer.put(SelectTurnLayout.backScreen).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
    ...
    private void renderMessage() {
        uvBuffer.put(Assets.selectTurnMessage.textureCoord).position(0);
        vertexBuffer.put(SelectTurnLayout.message).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
    ...
    private void renderStage() {
        ...
        vertexBuffer.put(SelectTurnLayout.stageDisplay).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
        ...
        vertexBuffer.put(SelectTurnLayout.fieldSizeDisplay).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
    ...
    private void renderMenuButtons() {
        uvBuffer.put(Assets.firstMoverButton.getKeyFrame(manager.getFirstMoverButton().getState(), Animation.ANIMATION_NONLOOPING).textureCoord).position(0);
        vertexBuffer.put(SelectTurnLayout.firstMoverButton).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);

        uvBuffer.put(Assets.secondMoverButton.getKeyFrame(manager.getSecondMoverButton().getState(), Animation.ANIMATION_NONLOOPING).textureCoord).position(0);
        vertexBuffer.put(SelectTurnLayout.secondMoverButton).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
        ...
        vertexBuffer.put(SelectTurnLayout.backButton).position(0);
        drawRect(ShaderAssets.texMVPMatrixHandle);
